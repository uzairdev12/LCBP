...
const UpdateProfile = () => {
  ...
  const updateProfile = async () => {
    ...
    try {
      ...
      localStorage.setItem("LCBPNAME", data.name);
      localStorage.setItem("LCBPEMAIL", data.email);
      localStorage.setItem("LCBPPHONE", data.number);

      localStorage.setItem("LCBPPASSWORD", data.password);
